...
tmp="$root/.index.generated.html"
{
  ...
  printf '%s\n' 'Object.assign(window.GAME_ART.holes,{crystal:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hole-premium-crystal-v1.png",tech:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hole-premium-tech-v1.png",jungle:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hole-premium-jungle-v1.png",lava:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hole-premium-lava-v1.png"});'
  printf '%s\n' 'window.GAME_ART.heroes=[{name:"Кибер-робот",url:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hero-robot-v1.png"},{name:"Ниндзя",url:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hero-ninja-v1.png"},{name:"Космонавт",url:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hero-astronaut-v1.png"},{name:"Маг",url:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hero-mage-v1.png"}];'
