...
tmp="$root/.index.generated.html"
{
  ...
  printf '%s\n' 'Object.assign(window.GAME_ART.holes,{crystal:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hole-premium-crystal-v2.png",tech:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hole-premium-tech-v2.png",jungle:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hole-premium-jungle-v2.png",lava:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hole-premium-lava-v2.png"});'
  printf '%s\n' 'window.GAME_ART.heroes=[{name:"Кибер-робот",url:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hero-robot-v2.png"},{name:"Ниндзя",url:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hero-ninja-v2.png"},{name:"Космонавт",url:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hero-astronaut-v2.png"},{name:"Маг",url:"https://raw.githubusercontent.com/galmizmaria-beep/krot/main/assets/hero-mage-v2.png"}];'
